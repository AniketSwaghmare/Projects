...
typedef struct inode
{
    ...
    int LinkCount;      // File tumhi kiti vela open kelei ti count krte
    int ReferenceCount;
...
void ls_File()          
{
    ...
    if(SUPERBLOCKobj.FreeInodes == MAXINODE)        // MAXINODE sagle rekami ahi ka hey check krtoy
    {
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                Backup_file();
                printf("Terminating the Aniket CVFS...\n\n");
                break;
            }
            else
            {
